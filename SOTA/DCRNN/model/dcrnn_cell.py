...
class DCGRUCell(torch.nn.Module):
    def __init__(self, num_units, adj_mx, max_diffusion_step, num_nodes, nonlinearity='tanh',
        ...
        if filter_type == "laplacian":
            supports.append(utils_HIAM.calculate_scaled_laplacian(adj_mx, lambda_max=None))
        elif filter_type == "random_walk":
            supports.append(utils_HIAM.calculate_random_walk_matrix(adj_mx).T)
        elif filter_type == "dual_random_walk":
            supports.append(utils_HIAM.calculate_random_walk_matrix(adj_mx).T)
            supports.append(utils_HIAM.calculate_random_walk_matrix(adj_mx.T).T)
        else:
            supports.append(utils_HIAM.calculate_scaled_laplacian(adj_mx))
